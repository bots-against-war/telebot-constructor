...
<div>
    ...
    <Stack align="left">
        ...
        <Space h="xs" />
        <Switch size="md" label="Анонимизировать юзеро_к" bind:checked={anonimyze_users} description="Присылать ли имя, юзернейм и id юзерки, или заменять его на эмоджи." />
        ...
        <Text size="m">В админ-чате создается отдельная тема на каждую юзерку, в которой будут все сообщения от нее.
        </Text>
    </Stack>
    <Space h="lg" />
    <Space h="lg" />
